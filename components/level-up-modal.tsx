          ...
          <>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-6 py-6">
                ...
                {step === 5 && (
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2">Select Automatic Domain Card</h3>
                    <p className="text-gray-400 mb-4">
                ...
                {step === 6 && (
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2">Select Additional Domain Card</h3>
                    <p className="text-gray-400 mb-4">
