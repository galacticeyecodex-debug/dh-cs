...
export default function CreateHomebrewItemModal({
  ...
  const handleDeleteClick = () => {
    ...
    setConfirmDialog({
      isOpen: true,
      title: 'Delete this Homebrew Item?',
      description: 'You are about to delete this custom item definition. This will remove it from your inventory and from your list of custom items. This cannot be undone.',
  ...
  const handleRemoveClick = () => {
    ...
    setConfirmDialog({
      ...
      description: 'This will remove the item from your character sheet. You can add it back later from the Library (if it is a standard item) or your Custom Items list.',
          ...
          >
            ...
            <div className="flex justify-between items-center p-6 border-b border-white/10">
              <h2 className="text-2xl font-bold text-dagger-gold">
                {isEditing ? 'Edit Item' : 'Create Homebrew Item'}
              </h2>
              <button
                onClick={handleClose}
            ...
            {/* Footer */}
            <div className="flex gap-3 p-6 border-t border-white/10 overflow-x-auto">
              {isEditing && (
                <div className="flex gap-2 mr-auto border-r border-white/10 pr-3">
                  {onDelete && (
                    <button
              ...
              <button
                onClick={handleClose}
                className="flex-1 py-3 px-6 bg-white/10 text-white font-bold rounded-full hover:bg-white/20 transition-all shrink-0"
              >
                Cancel
              </button>
              <button
