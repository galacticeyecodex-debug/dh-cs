...
const ADVANCEMENT_OPTIONS = [
  ...
  { id: 'increase_proficiency', name: 'Increase Proficiency', description: 'Gain +1 to Proficiency (+1 damage die)', cost: 2, minLevel: 5 },
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-start justify-between gap-3">
                              ...
                              <div className={`w-6 h-6 rounded border-2 flex items-center justify-center flex-shrink-0 ${isSelected ? 'bg-dagger-gold border-dagger-gold' : 'border-gray-600'
                                }`}>
